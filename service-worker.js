const CACHE='finance-ia-pro-v10.1.3';
const FILES=['./','./index.html','./style.css','./app.js','./v7-features.js','./v10-features.js','./cloud-sync.js','./config.js','./manifest.json','./icon-192.png','./icon-512.png'];
